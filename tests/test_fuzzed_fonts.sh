...
# Copyright (c) 2017-2021 The OTS Authors. All rights reserved.
# Use of this source code is governed by a BSD-style license that can be
# found in the LICENSE file.

# Usage: ./test_fuzzed_fonts.sh ots-fuzzer fonts_dir [ttf_or_otf_file_name]
...
if [ $# -gt 3 ] ; then
  echo "Usage: $0 ots-fuzzer fonts_dir [ttf_or_otf_file_name]"
  exit 1
fi
